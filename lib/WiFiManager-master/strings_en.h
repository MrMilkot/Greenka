...
const char HTTP_ROOT_MAIN[]        PROGMEM = "<h4>{t}</h4><h3>{v}</h3>";
...
"input,button,.msg{border-radius:0;width: 100%},input[type=radio]{width: auto}"
"button,input[type='button'],input[type='submit']{cursor:pointer;border:0;background-color:#7cdf30;color:#fff;line-height:2.4rem;font-size:1.2rem;width:100%}"
"input[type='file']{border:1px solid #7cdf30}"
".wrap {text-align:left;display:inline-block;min-width:260px;max-width:500px}"
// links
"a{color:#000;font-weight:700;text-decoration:none}a:hover{color:#7cdf30;text-decoration:underline}"
// quality icons
...
// msg callouts
".msg{padding:20px;margin:20px 0;border:1px solid #eee;border-left-width:5px;border-left-color:#777}.msg h4{margin-top:0;margin-bottom:5px}.msg.P{border-left-color:#7cdf30}.msg.P h4{color:#7cdf30}.msg.D{border-left-color:#dc3630}.msg.D h4{color:#dc3630}.msg.S{border-left-color: #5cb85c}.msg.S h4{color: #5cb85c}"
// lists
...
// invert
"body.invert,body.invert a,body.invert h1 {background-color:#FFF;color:#000000;}"
...
const char S_brand[]              PROGMEM = "Greenko";
